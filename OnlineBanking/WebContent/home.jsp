...
<nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="row text-center">
            ...
            <div class="panel panel-default text-center">
                ...
                <a href="deposit-own.jsp" class="btn btn-lg">DepositMoney In Your Account</a>
                    <br>
                    <a href="main-deposit.jsp" class="btn btn-lg">DepositMoney in SomeoneElse Account</a>
                </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-6">
            <div class="panel panel-default text-center">
                ...
                <div class="panel-body">
                <a href="withdrwal.jsp" class="btn btn-lg">WithdrwalMoney</a>
                </div>
                </div>
            </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6">
                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-body">
                    <a href="passbook.jsp" class="btn btn-lg">Passbook</a>
                    </div>
                </div>
                </div>
                <div class="col-sm-6 col-md-6">
                    ...
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Check Balance</button>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-header">
                                ...
                                <p>Your Balance is <%=u.getBalance()%></p>
                                </div>
