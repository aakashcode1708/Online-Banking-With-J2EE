...
<nav class="navbar navbar-default navbar-fixed-top">
        ...
        <strong>Your Withdrwal Successfully Processed!!!</strong>
        </div>
       ...
       <div class="container-fluid">
        <div class="row text-center">
            ...
            <div  class="panel panel-default text-center">
                ...
                <h1>Withdrwal Money</h1>
                </div>
                <div class="panel-body">
                <form action="withdrwal-validate.jsp" method="post" role="form" autocomplete="off">
                    <div class="form-group">
                    <label for="paynum">Paytm Number</label>
                    <input type="hidden" name="acc_no" value="<%=u.getAcc_no()%>">
                    <input type="text" name="paynum" placeholder="Enter Paytm Number" class="form-control" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                    <input type="submit" value="Withdrawl" class="btn btn-lg">
                    </div>
                    </form>
                </div>
                 </div>
