...
<nav class="navbar navbar-default navbar-fixed-top">
        ...
        <strong>Your Money Couldnot be Deposited!!!!</strong>
        </div>
        </div>
           ...
           <div class="col-sm-6 col-md-6">
            <div class="panel panel-default text-center">
               <div class="panel-heading">
                ...
                <form action="depositown-validate.jsp" method="post" role="form" class="form-horizontal col-sm-12 col-md-12">
                    <div class="form-group">
                    <label for="acc_no">Account Number</label>
                    <input type="text" id="acc_no" value="<%=u.getAcc_no()%>" class="form-control" name="acc_no" required>    
                    </div>
                    <div class="form-group">
                    <label for="amt">Amount</label>
                    <input type="text" id="amt" name="amt" class="form-control" placeholder="Enter Money To Deposit" required>    
                    </div>
                    <div class="form-group">
                    <input type="submit" value="Add Money" class="btn btn-lg">
                    </div>
                    </form>
                </div>
                <div class="panel-footer">
                <h2>Deposited Money Will be added to your account within 24 hrs</h2>
                </div>
               </div>
            </div>
           </div>
